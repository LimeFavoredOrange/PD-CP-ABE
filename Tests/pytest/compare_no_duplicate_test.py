...
def test_compare_no_duplicate():
    myABE_result, myABE_total, myABE_decryptable = test_myabe(duplicate=False)
    bsw07_result, bsw07_total, bsw07_decryptable = test_bsw07(duplicate=False)
